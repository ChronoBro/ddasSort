...
all: sortPID sort5 #sort5_gammaSearch#sort4_v3 sort4_v2 sort4 sort3_v2 sort3_v3 #sort3 sort3_v2 sort3_v3 sort4 #sortDev sort sort2 
...
sort5_gammaSearch: objs/sort5_gammaSearch.o $(OBJECTS) src/DDASdict.cpp
	$(COMPILER) -o sort5_gammaSearch objs/sort5_gammaSearch.o $(OBJECTS) $(LINKOPTION)

...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ddaschannel*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ddaschannel", ::ddaschannel::Class_Version(), "include/ddaschannel.h", 41,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::DDASEvent*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("DDASEvent", ::DDASEvent::Class_Version(), "include/DDASEvent.h", 26,
...
namespace {
  void TriggerDictionaryInitialization_DDASdict_Impl() {
...
#line 1 "DDASdict dictionary forward declarations' payload"
...
class __attribute__((annotate("$clingAutoload$include/DDASEvent.h")))  DDASEvent;
)DICTFWDDCLS";
...
nullptr};
  ...
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_DDASdict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_DDASdict() {
  TriggerDictionaryInitialization_DDASdict_Impl();
}
